...
import { SlottedIconManager, type VariantAttribute, VariantAttributeConverters } from '../base/FxCore';
import './FxIcon';
...
export class FxTab extends FxContentElement {
    ...
    @property({ reflect: true, converter: VariantAttributeConverters.optional }) variant?: VariantAttribute;
