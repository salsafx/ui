...
import { SlottedIconManager, SlottedBadgeManager } from '../base/FxCore';
import './FxIcon';
...
export class FxCard extends FxContentElement {
    ...
    private readonly slottedBadges = new SlottedBadgeManager(this);
    ...
    connectedCallback() {
        ...
        this.syncBadge();
        void customElements.whenDefined('fx-badge').then(() => this.syncBadge());
    }
    ...
    private syncBadge() {
        this.slottedBadges.manage(this.badge, {
