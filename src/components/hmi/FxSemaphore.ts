...
import { hostHasIconSlot, iconSlotName, syncSwitchHostIcons } from '../base/FxCore';
...
export class FxSemaphore extends Animatable(FxElement) {
    static readonly defaultStates: ReadonlyArray<FxSemaphoreStateData> = [
        { value: 'stop', color: '#ef4444', label: '' },
        { value: 'warn', color: '#fbbf24', label: '' },
        { value: 'go', color: '#22c55e', label: '' },
    ];
