...
export class FxLinearGauge extends Animatable(FxMeasureElement) {
    ...
    private getScaleValueOrigin(): 'start' | 'end' {
        return LinearScale.slottedValueOrigin(this, 'scale', this.valueOrigin);
    }
    ...
    private renderRegions(
        ...
        const isReverse = LinearScale.isReversed(
    ...
    private renderVerticalTube() {
        ...
        const isReverse = LinearScale.isReversed('vertical', this.getScaleValueOrigin());
    ...
    private renderHorizontalTube() {
        ...
        const isReverse = LinearScale.isReversed('horizontal', this.getScaleValueOrigin());
        const fillLength = Math.max(progress * wellLength, 0);
    ...
    private get scaleOffsets() {
        ...
        const { startOffset, endOffset } = LinearScale.offsets(
            orientation,
            this.getScaleValueOrigin(),
            wellLength,
            0
